...
- **Camera Mood**: Idle.
- **Expected Transition**: Fade into atmosphere.
...
- **Camera Mood**: Floating.
- **Expected Transition**: Slow exposure to a wider view.
...
- **Camera Mood**: Observing.
- **Expected Transition**: Cross dissolve to a deeper reveal.
...
- **Camera Mood**: Investigating.
- **Expected Transition**: Slow exposure with sustained focus.
...
- **Camera Mood**: Observing.
- **Expected Transition**: Cross dissolve to act II.
